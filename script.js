...
if (document.getElementById("quiz-section")) {
   ...
   const explanations = [
    ...
    "Phishing emails will create fear by claiming your social security number has been suspended. Official agencies never communicate such information through email or calls.",
    "Legitimate companies may send password expiry warnings, but ensure the domain matches the official company domain. Access your account directly through the official website to confirm.",
    "This is a phishing attempt. Voicemail notifications are rarely sent through unfamiliar domains. Always verify links and sources."
];
